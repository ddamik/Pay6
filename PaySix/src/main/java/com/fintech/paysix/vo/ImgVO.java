...
public class ImgVO {
	...
	public ImgVO(int img_seq, String img_origin_name, String img_origin_url, String img_save_name, String img_save_url,
			int img_store_fk, int img_product_fk) {
		super();
		...
		this.img_save_url = img_save_url;
	...
	public void setImg_save_url(String img_save_url) {
		this.img_save_url = img_save_url;
	}
	...
	public String toString() {
		return "ImgVO [img_seq=" + img_seq + ", img_origin_name=" + img_origin_name + ", img_origin_url="
				+ img_origin_url + ", img_save_name=" + img_save_name + ", img_save_url=" + img_save_url
